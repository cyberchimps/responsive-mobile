...
?>
	...
	<footer id="footer" class="site-footer clearfix" role="contentinfo">
		...
		<div id="footer-wrapper" class="row">
			...
			<div class="<?php echo get_responsive_grid( 'col-12' ); ?>">
				<div class="row">
					<div class="<?php echo get_responsive_grid( 'col-7' ); ?>">
					...
					<div class="<?php echo get_responsive_grid( 'col-5', true ); ?>">
					<?php echo responsive_social_icons() ?>
					</div><!-- .col-380 fit -->
				</div>
			</div><!-- .col-940 -->
			<?php get_sidebar( 'colophon' ); ?>
			<div class="<?php echo get_responsive_grid( 'col-4' ); ?> copyright">
			...
			<div class="<?php echo get_responsive_grid( 'col-4' ); ?> scroll-top">
				<a href="#scroll-top" title="<?php esc_attr_e( 'scroll to top', 'responsive' ); ?>"><?php _e( '&uarr;', 'responsive' ); ?></a>
			</div><!-- .scroll-top -->

			<div class="<?php echo get_responsive_grid( 'col-4', true ); ?> powered">
