				...
				<?php if ( is_array( $responsive_data ) ) : ?>
					...
					<?php if ( is_array( $responsive_data['image_meta'] ) ) : ?>
						<?php if ( $responsive_data['image_meta']['aperture'] ) : ?>
							<span
								class="aperture"><?php _e( 'Aperture: f&#47;', 'responsive-II' ); ?><?php echo $responsive_data['image_meta']['aperture']; ?></span>
						<?php endif; ?>

						<?php if ( $responsive_data['image_meta']['focal_length'] ) : ?>
							<span
								class="focal-length"><?php _e( 'Focal Length:', 'responsive-II' ); ?> <?php echo $responsive_data['image_meta']['focal_length']; ?><?php _e( 'mm', 'responsive-II' ); ?></span>
						<?php endif; ?>

						<?php if ( $responsive_data['image_meta']['iso'] ) : ?>
							<span
								class="iso"><?php _e( 'ISO:', 'responsive-II' ); ?> <?php echo $responsive_data['image_meta']['iso']; ?></span>
						<?php endif; ?>
						...
						<?php if ( $responsive_data['image_meta']['camera'] ) : ?>
							<span
								class="camera"><?php _e( 'Camera:', 'responsive-II' ); ?> <?php echo $responsive_data['image_meta']['camera']; ?></span>
						<?php endif; ?>
					<?php endif; ?>
				<?php endif; ?>
			</ul>
