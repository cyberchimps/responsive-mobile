...
function cyberchimps_admin_style() {
	...
	wp_register_style( 'upsell-style', $template_directory_uri . '/core/css/upsell' . $suffix . '.css', array( 'responsive-bootstrap' ), '2.0.0' );
	wp_register_style( 'responsive-theme-options', $template_directory_uri . '/core/css/theme-options' . $suffix . '.css', array(), '2.0.0' );
	wp_register_script( 'responsive-theme-options', $template_directory_uri . '/core/js/theme-options' . $suffix . '.js', array( 'jquery' ), '2.0.0' );
}
