...
if ( !class_exists( 'Responsive_Theme_Options' ) ) {
	...
	class Responsive_Theme_Options {
		...
		public function __construct() {
			$this->options = new Responsive_Options( $this->sections(), $this->options() );
			self::$get_options = $this->options->get_parse_options();
			add_action( 'wp_loaded', array( $this, 'responsive_options_setup' ) );
		}
		...
		public function responsive_options_setup() {
			return $this->options;
		}
	...
	Responsive_Theme_Options::instance();
}